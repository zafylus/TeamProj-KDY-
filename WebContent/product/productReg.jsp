        ...
        <div class="row justify-content-center mt-5 pt-5">
            ...
            <form action="product-regist" method="post">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="ma001" placeholder="200" aria-label="Amount (to the nearest dollar)">
                    <span class="input-group-text">g</span>
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text">우유</span>
                    <input type="text" class="form-control" name="ma002" placeholder="200" aria-label="Amount (to the nearest dollar)">
                    <span class="input-group-text">ml</span>
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text">시럽</span>
                    <input type="text" class="form-control" name="ma003" placeholder="200" aria-label="Amount (to the nearest dollar)">
                    <span class="input-group-text">ml</span>
                </div>
